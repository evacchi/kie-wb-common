...
public class IntermediateCatchEventConverter {
    ...
    public Node<? extends View<? extends BPMNViewDefinition>, ?> convertIntermediateCatchEvent(IntermediateCatchEvent event) {
    ...
    private Node<View<IntermediateErrorEventCatching>, Edge> errorEvent(CatchEvent event, ErrorEventDefinition e) {
        String nodeId = event.getId();
    ...
    public Node<? extends View<? extends BPMNViewDefinition>, ?> convertBoundaryEvent(BoundaryEvent event) {
        List<EventDefinition> eventDefinitions = event.getEventDefinitions();
        switch (eventDefinitions.size()) {
            case 0:
    ...
    private Node<View<IntermediateSignalEventCatching>, Edge> signalEvent(CatchEvent event, SignalEventDefinition e) {
        String nodeId = event.getId();
    ...
    private Node<View<IntermediateTimerEvent>, Edge> timerEvent(CatchEvent event, TimerEventDefinition e) {
        String nodeId = event.getId();
    ...
    private Node<View<IntermediateMessageEventCatching>, Edge> messageEvent(CatchEvent event, MessageEventDefinition e) {
        String nodeId = event.getId();
